        ...
        <div class="left col-sm-8 p-20-0">
            ...
            <div class="experience mb-25">
                <div class="traveler_body mb-25">
                    ...
                    <!-- FOR ADULT -->
                    <div class="detail_form row m-0">
                        <div class="col-sm-2 form-group m-0 center">
                            <label for="usr" style="margin: 25px 0px">Adult</label>
                            <div></div>
                        </div>
                    ...
                    <!-- FOR child -->
                    <div class="detail_form row m-0">
                        <div class="col-sm-2 form-group m-0 center p-0">
                            <label for="usr" style="margin: 25px 0px">Child(2-12Yrs)</label>
                            <div></div>
                        </div>
                        <div class="col-sm-2 form-group m-0 p-0">
                            <div>Title</div>
                            <div>
                                <select name="" id="gender-title">
                                    <option value="">Title</option>
                        ...
                        <div class="col-sm-4 form-group m-0 p-0-8">
                            <div>First Name</div>
                            <div><input type="text" class="form-control"></div>
                        </div>
                        <div class="col-sm-4 form-group m-0 p-0-8">
                    ...
                    <div class="detail_form row m-0">
                        <div class="col-sm-2 form-group m-0 center p-0">
                            <label for="usr" style="margin: 25px 0px">Infant(0-2Yrs)</label>
                            <div></div>
                        </div>
                        <div class="col-sm-2 form-group m-0 p-0">
                            <div>Title</div>
                    ...
                    <div class="pt-25">
                        <div class="form-group row p-8-0 center m-0">
                            ...
                            <input type="email" class="col-sm-3 border_light" required id="email">
                        </div>
                        <div class="form-group row p-8-0 center m-0">
                            <label for="number" class="col-sm-2">Contact Form</label>
                            <input type="text" class="col-sm-3 border_light" required id="c_no">
                        </div>
                        <div class="form-group row p-8-0 center m-0">
                            <label for="city" class="col-sm-2">City of Residence</label>
                            <input type="email" class="col-sm-3 border_light" required id="city">
                        </div>
                    </div>
                </div>
                    ...
                    <div id="receipt-price p-0">
                        <div id="order_summary p-0" style="list-style:none;padding:0px;font-weight:600">
                            ...
                            <div class="row m-0 p-0">
                                ...
                                <h3 class="col-sm-5 p-0">AED 6644</h3>
                            </div>
